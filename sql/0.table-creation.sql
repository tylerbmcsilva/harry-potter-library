...
CREATE TABLE `hpcharacter` (
  ...
  PRIMARY KEY (id),
  CONSTRAINT FOREIGN KEY (house_id) REFERENCES house(id) ON DELETE SET NULL ON UPDATE CASCADE
)ENGINE=InnoDB AUTO_INCREMENT=1000;
...
CREATE TABLE `house` (
  ...
  PRIMARY KEY (id),
  CONSTRAINT FOREIGN KEY (founder_id) REFERENCES hpcharacter(id) ON DELETE SET NULL ON UPDATE CASCADE,
